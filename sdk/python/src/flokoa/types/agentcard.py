...
#   timestamp: 2026-02-02T22:21:56+00:00
...
class Capabilities(BaseModel):
    ...
    state_transition_histroy: Annotated[bool | None, Field(alias="stateTransitionHistroy")] = None
...
class AgentCard(BaseModel):
    ...
    capabilities: Annotated[
        Capabilities,
        Field(default_factory=lambda: Capabilities.model_validate({"streaming": False})),
    ]
