...
_BLOCKED_IP_NETWORKS = [
    ...
    ipaddress.ip_network("::ffff:0.0.0.0/104"),  # IPv4-mapped "this" network
    ipaddress.ip_network("::ffff:100.64.0.0/106"),  # IPv4-mapped shared address space (CGN)
    ipaddress.ip_network("::ffff:192.0.0.0/104"),  # IPv4-mapped 192.0.0.0/8 (IETF range + private superset)
]
